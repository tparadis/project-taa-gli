(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('projectTaaGliApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-projectTaaGliApp-error');
                var entityKey = httpResponse.headers('X-projectTaaGliApp-params');
                if (errorHeader) {
