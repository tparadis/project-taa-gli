...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "project_taa_gli@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "project_taa_gli API";

        private String description = "project_taa_gli API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "project_taa_gli";
