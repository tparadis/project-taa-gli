...
class ContactGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Contact entity")
        ...
        .repeat(2) {
            ...
            .post("/api/contacts")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "nom":"SAMPLE_TEXT", "prenom":"SAMPLE_TEXT", "role":"SAMPLE_TEXT", "sexe":"SAMPLE_TEXT", "tel":"SAMPLE_TEXT", "mail":"SAMPLE_TEXT", "dateMaj":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
