...
class EtudiantGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Etudiant entity")
        ...
        .repeat(2) {
            ...
            .post("/api/etudiants")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "nom":"SAMPLE_TEXT", "prenom":"SAMPLE_TEXT", "sexe":"SAMPLE_TEXT", "rue":"SAMPLE_TEXT", "ville":"SAMPLE_TEXT", "codeDep":"SAMPLE_TEXT", "telephone":"SAMPLE_TEXT", "premierEmploi":"SAMPLE_TEXT", "dernierEmploi":"SAMPLE_TEXT", "rechEmp":null, "dateMaj":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
